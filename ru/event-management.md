...
* [Управление отслеживаемыми событиями](#-управление-отслеживаемыми-событиями)
* [Просмотр всех отслеживаемых событий](#-просмотр-всех-отслеживаемых-событий)
* [Редактирование конкретного события](#-редактирование-конкретного-события)
* [Массовое редактирование](#-массовое-редактирование)
...
* [Добавить Polymarket Event](./add-event.md) — как новые оддсы попадают в watchlist
* [Настройка алертов Polymarket](./alerts-and-filters.md) — полный референс по ✏️ панели
* [Лимиты тарифов](./plan-limits.md) — как считается квота и upsell-карточка
