...
<!-- screenshot: страница события Polymarket с подсвеченной адресной строкой -->
{% endstep %}

{% step %}
### Скопируйте ссылку на событие

Скопируйте URL из адресной строки. Подходит любой прямой URL события — короткий, длинный, с query-параметрами или без них.

{% hint style="warning" %}
Ссылка должна вести на **конкретное событие**, а не на главную Polymarket или раздел-категорию. <!-- VERIFY: подтвердить точный паттерн URL, который принимает бот -->
{% endhint %}
{% endstep %}
