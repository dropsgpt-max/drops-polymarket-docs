...
* [Параметры алертов](#-параметры-алертов)
* [Панель настроек оддса](#-панель-настроек-оддса)
* [Маршрутизация Telegram-уведомлений](#%EF%B8%8F-маршрутизация-telegram-уведомлений)
* [Готовые наборы порогов](#-готовые-наборы-порогов)
* [FAQ](#-faq)
...
* [Добавить Polymarket Event](./add-event.md) — как вообще добавлять оддсы
* [Управление событиями](./event-management.md) — как открыть ✏️ панель из watchlist
* [Активность кошельков на Polymarket](./wallet-activity.md) — алерты по wallet-активности, без per-oddsy порогов
